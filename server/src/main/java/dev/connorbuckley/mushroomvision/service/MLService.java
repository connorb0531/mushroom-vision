...
public class MLService {
    ...
    @Value("${ml.predict.script.path:ML/predict.py}")
    private String predictScriptPath;

    @Value("${ml.model.path:ML/mushroom_cnn_model.pth}")
    ...
    public ClassificationResponse classifyImage(String imageData) {
        ...
        try {
            ...
            ClassificationResponse.ClassificationResult.Probabilities probObj =
                    ClassificationResponse.ClassificationResult.Probabilities.builder()
                            .edible(edible)
                            .poisonous(poisonous)
                            .build();

            ClassificationResponse.ClassificationResult classificationResult =
                    ClassificationResponse.ClassificationResult.builder()
